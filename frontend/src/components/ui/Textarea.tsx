    ...
    ({ className, icon, resizable = false, ...props }, ref) => (
        <div className="relative w-full">
            ...
            <textarea
                ...
                rows={2}
                className={cn(
                    'w-full min-h-[60px] max-h-[400px] rounded-xl nz-bg-input nz-text-input focus:nz-ring px-3 py-2 text-sm font-semibold transition duration-300 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50',
                    icon && 'pl-10',
